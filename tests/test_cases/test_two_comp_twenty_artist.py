    ...
    assert json.loads(response.data) == {
            ...
            'detail':
                [
                    ...
                    'balance_forward': 15.8,
                    'split': 15.8,
                    'total_advance': 0.0,
                    'total_previous_balance': 0.0,
                    'total_recoupable': 0.0,
                    'total_sales': 31.59,
                    'total_to_split': 31.59,
                    },
                    {
                    'id': 4,
                    ...
                    'balance_forward': 34.82,
                    'split': 34.82,
                    'total_advance': 0.0,
                    'total_previous_balance': 0.0,
                    'total_recoupable': 0.0,
                    'total_sales': 69.63,
                    'total_to_split': 69.63,
                    },
                    {
                    'id': 6,
